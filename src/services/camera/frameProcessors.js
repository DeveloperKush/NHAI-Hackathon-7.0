...
exports.processCameraFrame = processCameraFrame;
exports.simulateLandmarksFromFrame = simulateLandmarksFromFrame;
exports.captureEnrollmentFrames = captureEnrollmentFrames;
const base_64_1 = __importDefault(require("base-64"));
const imagePreProc_1 = require("../../utils/imagePreProc");
/**
...
async function processCameraFrame(frame) {
    ...
    const equalized = (0, imagePreProc_1.applyCLAHE)(resized, destSize, destSize);
    // Map [0, 255] grayscale intensity to [-1.0, 1.0] Float32Array
    return (0, imagePreProc_1.normalizePixels)(equalized);
}
/**
 ...
 */
function simulateLandmarksFromFrame(frame, isRealFace) {
    const landmarks = [];
 ...
 */
async function captureEnrollmentFrames(cameraRef, count = 5) {
    const base64Photos = [];
